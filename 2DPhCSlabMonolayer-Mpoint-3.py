...
### ==============================================================================
#       
#       Fit the effective model for 2D photonic crystal slab
#                       monolayer
#
### ==============================================================================
...
for i in range(3*Nk+4): 
    ...
    evalues, evectors = HamiltonianMpoint(qx, qy, omegaM_e, ve, Ue, We) 
...
PhotonicBands_e = np.loadtxt('2Dmonolayer-h_0.3-r_0.4-zeven.txt') 
...
for i in range(3*Nk+4): 
    ...
    evalues, evectors = HamiltonianMpoint(qx, qy, omegaM_o, vo, Uo, Wo) 
...
# Load the band structure calculated from MPB
PhotonicBands_o = np.loadtxt('2Dmonolayer-h_0.3-r_0.4-zodd.txt') 
...
### Load the light-cone
# Load the light cone 
LightCone = np.loadtxt('SiO2-TE-Zoom1.txt')
