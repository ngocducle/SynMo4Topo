...
from FDTD_2Dstructures import geom_2DSlab2L_RHoleP_hj_sameMater_Defect
...
sy = structurey + 2*dboundary      # no pad, with PML/absorber
sz = Lz + 2*dboundary
...
for idelta in range(Ndelta):
    ...
    ##### ===========================================================================
    ##### GEOMETRY
    geometry = geom_2DSlab2L_RHoleP_hj_sameMater_Defect(d,h,hbilayer,delta,
                                             vertice1,vertice2,
