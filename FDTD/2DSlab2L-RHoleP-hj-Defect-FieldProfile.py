...
sources = [
    mp.Source(
        ...
        component = component,
        center = mp.Vector3(-delta/2-0.027,0.0,0.0026),
        size = mp.Vector3(0,structurey,0)
    )
]
...
y_array = np.linspace(-0.5*structurey,0.5*structurey,np.shape(eps_data)[1])
