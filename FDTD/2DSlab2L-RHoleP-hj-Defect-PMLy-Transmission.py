...
from FDTD_2Dstructures import geom_2DSlab2L_RHoleP_hj_sameMater_Rectangle_CircleDefect_PMLy
...
sy = structurey + 2*dboundary # no pad, with PML
sz = Lz + 2*dboundary
...
for idelta in range(Ndelta):
    ...
    ##### ===========================================================================
    ##### GEOMETRY
    geometry = geom_2DSlab2L_RHoleP_hj_sameMater_Rectangle_CircleDefect_PMLy(d,h,hbilayer,delta,
                                             vertice1,vertice2,
                                             Mater,Envir,Ncell_x,Ncell_y,sx,sy,radius)
