...
for iq = 1:Nq 
    ...
    for ik = 1:Nk 
        ...
        %%%%% The left-hand side 
        %%% The Hamiltonian 
        H = Hamiltonian(k,q,omega1,v1,U1,W1,alpha1,eta1,omega0,v0,U0,W0,alpha1,eta1,beta1,V1,d1,d0);
        ...
        %%%%% The right-hand side 
        %%% The Hamiltonian 
        H = Hamiltonian(k,q,omega2,v2,U2,W2,alpha2,eta2,omega0,v0,U0,W0,alpha2,eta2,beta2,V2,d2,d0);
    ...
    for iE = 1:NE 
        ...
        [WL,kL] = kPolyEig(E,q,omega1,v1,U1,W1,alpha1,eta1,omega0,v0,U0,W0,alpha1,eta1,beta1,V1,d1,d0);

        % Right-hand Hamiltonian 
        printf("Right-hand Hamiltonian \n");
        [WR,kR] = kPolyEig(E,q,omega2,v2,U2,W2,alpha2,eta2,omega0,v0,U0,W0,alpha2,eta2,beta2,V2,d2,d0);
