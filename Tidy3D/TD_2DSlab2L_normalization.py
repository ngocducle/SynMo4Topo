...
# Runtime 
runtime = 20.0 # in unit of 1/frequency bandwidth of the source
...
# Simulation size 
sim_size = Lx,Ly,Lz = (2*pad,d,2*h+dist+2*lambda_range[-1])
...
plt.savefig('Sources_profile.png')
plt.show()

##### Running simulation
sim_data = web.run(sim,task_name='2DSlab2L_transmission',path=f'data/2DSlab2L-normalization.hdf5')