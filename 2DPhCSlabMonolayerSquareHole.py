...
############################################################################
#
#   Simulation of 2D photonic crystal slab monolayer 
#   with square unit cell of cell parameter a = 1 
#   thickness h, and a square hole at the center. 
#   The edge of the square hole is b < a = 1.
# 
############################################################################  
...
h = 0.90       # Thickness of one layer 
b = 0.80       # Edge of the square hole 
...
geometry = [ mp.Block(center = mp.Vector3(0, 0, 0), 
             ...
             mp.Block(center = mp.Vector3(0, 0, 0), 
                      size = mp.Vector3(b,b,h),  
                      material = Environnement)
           ] 

### Define the k-points 
# For the band structure in the Brillouin zone 
...
#k_points = [ 
#             mp.interpolate(7,  [ mp.Vector3(0,0,0), mp.Vector3(0.5,0,0) ] ),     # Gamma - X
#             mp.interpolate(29, [ mp.Vector3(0.5,0,0), mp.Vector3(0.5,0.5,0) ] ), # X - M 
#             mp.interpolate(29, [ mp.Vector3(0.5,0.5,0), mp.Vector3(0,0,0) ] ),   # M - Gamma 
#            ]

# Set of k-points to fit 
#k_points = [ mp.Vector3(0.3, 0.3, 0),  # Gamma'  
#             mp.Vector3(0.5, 0, 0),      # X'  
#             mp.Vector3(0.5, 0.5, 0),    # M  
#             mp.Vector3(0.3, 0.3,0)    # Gamma'   
#           ]
...
for k in range(9): 
    ...
    fig, ax = plt.subplots()
    plt.pcolormesh(xplot,yplot,refractiveindex,cmap='RdBu',vmin=0,vmax=12.5)  
