...
##### the source emits the electromagnetic wave along the diagonal direction
##### that we choose to be the x-direction
def geom_2DSlab2L_RHoleP_hj_sameMater_Rectangle_PBCy(d,h,hbilayer,delta,
                                             vertice1,vertice2,
...
##### the source emits the electromagnetic wave along the diagonal direction
##### that we choose to be the x-direction
def geom_2DSlab2L_RHoleP_hj_sameMater_Rectangle_PMLy(d,h,hbilayer,delta,
                                             vertice1,vertice2,
                                             Mater,Envir,Ncell_x,Ncell_y,sx,sy):
...
def geo_2DSlab2L_RHoleP_hj_sameMater_CircleDefectBulk_PBCy(d,h,hbilayer,delta,
                                     vertice1,vertice2,
                                     Mater,Envir,Ncell,sx,sy,
                                     radius):
    ### Initialize the geometry with environment
...
##### the source emits the electromagnetic wave along the diagonal direction
##### that we choose to be the x-direction
def geom_2DSlab2L_RHoleP_hj_sameMater_Rectangle_CircleDefect_PMLy(d,h,hbilayer,delta,
                                             vertice1,vertice2,
                                             Mater,Envir,Ncell_x,Ncell_y,sx,sy,
                                             radius):
