...
def main():
    ...
    ms = _2DSlab1LSquareHole(h,Lz,edge,num_bands,Nk,resolution,kSpace,Mater,Envir)
    ...
    namesave = '2DSlab1L-SquareHole-h_'+str(h)+'-b_'+str(edge) \
        +'-'+polarization+'-'+kSpace 
    ...
    Efieldx,Efieldy,Efieldz,X,Y,Xfield,Yfield,eps_Oxy = EFields_2DSlab1LCircularHole(h,Lz,
                                radius,num_bands,resolution,Mater,Envir,
                                k_field,zvalue,
