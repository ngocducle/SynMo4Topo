...
from LightCone import LightCone
    ...
    #                                                                               #
    #       Scan over e1 = e2 = e in linspace(-0.1, 0.1, 21)                       #
    #                                                                               #
...
e_array = np.linspace(-0.1, 0.1, 21)
print('\n# Scanning e = e1 = e2 over:')
print(e_array)
...
for e in e_array:
    ...
    print('\n'+'='*70)
    print('# e = e1 = e2 = '+str(e))
    print('# The anisotropy between the two diagonals e1 = e2 = '+str(e))
    ...
    namesave = '1p1D-2DSlab2L-RHoleP-h1_'+str(h1)+'-b1_'+str(b1)+'-e1_'+str(round(e1,4)) \
            + '-h2_'+str(h2)+'-b2_'+str(b2)+'-e2_'+str(round(e2,4)) \
            + '-d_'+str(dist)+'_kq'
